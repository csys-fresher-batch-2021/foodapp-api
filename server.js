...
app.delete('/api/v1/orders/:id', orderController.delete);
app.get('/api/v1/orders/:id', orderController.findOne);
app.get('/api/v1/orders/:id', orderController. getMyOrders);
